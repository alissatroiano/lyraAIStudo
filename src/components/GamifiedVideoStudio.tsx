...
export default function GamifiedVideoStudio({
  ...
  return (
    <div data-theme={theme} className="space-y-6 animate-fade-in font-nocturne text-noct-text">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h3 className="text-xl font-black text-white flex items-center gap-2">
                <span>Snori Video Gamification Engine</span>
      ...
      {!pkg && !isGamifying && (
        <div className="bg-noct-surface border border-noct-border/60 rounded-3xl p-10 text-center space-y-4 shadow-2xs">
          <div className="w-16 h-16 rounded-3xl bg-purple-500/15 text-purple-300 flex items-center justify-center mx-auto">
            <Clapperboard className="w-8 h-8 text-purple-300" />
          </div>
          <h4 className="text-lg font-bold text-noct-text">Ready to Gamify This STEM Lesson?</h4>
          <p className="text-xs text-noct-text/60 max-w-md mx-auto leading-relaxed">
            Click the button above to launch Snori&apos;s 3-step Gamify, Script, and Storyboard pipeline. Gemini will search live gaming trends (Minecraft, Fortnite, Roblox) to craft custom Video Game Cutscenes & Cartoon Scripts!
          </p>
          <button
            type="button"
            onClick={handleGenerateGamifiedPackage}
            className="px-6 py-3 rounded-xl bg-noct-accent hover:bg-noct-accent-light text-noct-bg font-bold text-xs transition-all inline-flex items-center gap-2 cursor-pointer"
          >
      ...
      {isGamifying && (
        <div className="bg-noct-surface border border-noct-border/60 rounded-3xl p-12 text-center space-y-4 shadow-2xs animate-pulse">
          <div className="w-14 h-14 rounded-2xl bg-purple-500/15 text-purple-300 flex items-center justify-center mx-auto">
            <Search className="w-7 h-7 text-purple-300 animate-spin" />
          </div>
          <h4 className="text-base font-bold text-noct-text">Researching Gaming Trends & Crafting Scripts...</h4>
          <p className="text-xs text-noct-text/60 max-w-md mx-auto">
      ...
      {pkg && !isGamifying && (
        <div className="space-y-6">
          ...
          <div className="bg-noct-surface border border-noct-border/60 rounded-3xl p-6 sm:p-8 shadow-xs space-y-5">
            <div className="flex items-center justify-between border-b border-noct-border/60 pb-4">
              <div className="flex items-center gap-2.5">
                <span className="p-2 rounded-xl bg-purple-500/15 text-purple-300">
                  <Gamepad2 className="w-5 h-5 text-purple-300" />
                </span>
                <h4 className="text-base font-extrabold text-noct-text flex items-center gap-2">
              ...
              {pkg.gamificationBreakdown.groundingSources && pkg.gamificationBreakdown.groundingSources.length > 0 && (
                <div className="flex items-center gap-1.5 text-[10px] text-noct-text font-bold font-mono bg-teal-brand/10 border border-teal-brand/20 px-2.5 py-1 rounded-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Target Concept */}
              <div className="p-4 rounded-2xl bg-noct-bg border border-noct-border/60 space-y-1">
                <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-noct-text/40 block">
                  Target STEM Concept
                </span>
                <p className="text-sm font-bold text-noct-text">
              ...
              <div className="p-4 rounded-2xl bg-purple-500/10 border border-purple-500/25 space-y-1">
                ...
                <p className="text-sm font-bold text-purple-100 flex items-center gap-1.5">
              ...
              <div className="p-4 rounded-2xl bg-teal-brand/10 border border-teal-brand/20 space-y-1">
                <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-noct-text block">
                  The Game Analogy
                </span>
                <p className={`text-xs text-noct-text leading-relaxed font-medium ${dyslexiaMode ? "dyslexia-mode-styles" : ""}`}>
            ...
            {pkg.gamificationBreakdown.groundingSources && pkg.gamificationBreakdown.groundingSources.length > 0 && (
              <div className="pt-2 flex flex-wrap items-center gap-2">
                <span className="text-[10px] font-mono font-bold text-noct-text/40 uppercase">
                  Research Sources:
                </span>
                {pkg.gamificationBreakdown.groundingSources.map((source, sIdx) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-[11px] font-bold text-noct-accent-light hover:text-noct-accent bg-noct-bg hover:bg-white/10 border border-noct-border/60 px-2.5 py-1 rounded-lg transition-all"
                  >
                    <span>{source.title}</span>
                    <ExternalLink className="w-3 h-3 text-noct-text/40" />
                  </a>
                ))}
              </div>
            )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-noct-surface border border-noct-border/60 rounded-3xl p-6 shadow-xs space-y-5 flex flex-col justify-between">
              <div className="space-y-4">
                
                {/* Concept Header */}
                <div className="flex items-center justify-between border-b border-noct-border/60 pb-3">
                  <div className="flex items-center gap-2">
                    <span className="p-1.5 rounded-xl bg-purple-500/15 text-purple-300">
                      <Film className="w-4 h-4 text-purple-300" />
                    </span>
                    <h4 className="text-sm font-extrabold text-noct-text uppercase tracking-wider font-mono">
                      Concept 1: Video Game Cutscene
                    </h4>
                  </div>
                  <span className="text-[10px] font-mono font-bold bg-purple-500/15 text-purple-200 border border-purple-500/30 px-2.5 py-0.5 rounded-full">
                    Duration: ~{pkg.cutsceneConcept.duration || "60-90s"}
                  </span>
                </div>

                <div className="space-y-2">
                  <h3 className="text-lg font-black text-noct-text">
                ...
                <div className="space-y-1.5">
                  <span className="text-[10px] font-mono font-bold uppercase text-noct-text/40 block">
                    Cast & Character Roster
                  </span>
                  <div className="flex flex-wrap gap-2">
                    {pkg.cutsceneConcept.characters.map((char, cIdx) => (
                      <span key={cIdx} className="text-xs font-bold bg-noct-bg text-noct-text border border-noct-border/60 px-2.5 py-1 rounded-xl">
                        👤 {char}
                      </span>
                    ))}
                  </div>
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold uppercase text-noct-text/40">
                      Script & Visual Directions
                    </span>
                    ...
                    {speakText && (
                      <button
                        ...
                        className="text-[10px] font-bold text-noct-accent-light hover:text-noct-accent flex items-center gap-1 cursor-pointer"
                      >
                        {isSpeaking ? <VolumeX className="w-3.5 h-3.5 text-red-500" /> : <Volume2 className="w-3.5 h-3.5 text-noct-accent" />}
                  ...
                  <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1">
                    {pkg.cutsceneConcept.script.map((line, lIdx) => (
                      <div key={lIdx} className="p-3 rounded-2xl border border-noct-border/60 bg-noct-bg/70 space-y-1.5 text-xs">
                        {line.visual && (
                        ...
                        {line.character && line.dialogue && (
                          <div className="pl-1 pt-1 font-medium text-noct-text">
                            <span className="font-extrabold text-noct-text font-mono mr-1.5 uppercase text-[11px]">
                              {line.character}:
                            </span>
                ...
                <div className="p-3 bg-amber-500/10 border border-amber-500/25 rounded-2xl text-xs text-amber-100 space-y-0.5">
                  <span className="font-bold text-amber-300 uppercase text-[10px] font-mono block">
                    🎯 Educational Takeaway
                  </span>
              ...
              <div className="pt-4 border-t border-noct-border/60 space-y-3">
                {cutsceneVideoUrl ? (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs font-bold text-noct-text">
                      ...
                      <button
                        ...
                        className="text-[10px] text-noct-text/50 hover:underline hover:text-noct-text cursor-pointer"
                      >
                        Re-render Video
                      </button>
                    </div>
            ...
            <div className="bg-noct-surface border border-noct-border/60 rounded-3xl p-6 shadow-xs space-y-5 flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between border-b border-noct-border/60 pb-3">
                  <div className="flex items-center gap-2">
                    <span className="p-1.5 rounded-xl bg-amber-500/15 text-amber-300">
                  ...
                  <span className="text-[10px] font-mono font-bold bg-amber-500/15 text-amber-200 border border-amber-500/30 px-2.5 py-0.5 rounded-full">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-amber-500/10 text-amber-100 p-3.5 rounded-2xl text-xs space-y-1.5 font-sans border border-amber-500/25">
                    <span className="text-[10px] font-mono font-bold uppercase text-amber-300 block tracking-wider">
                      🎭 The Scenario Setup
                    </span>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {pkg.cartoonConcept.characters.map((char, cIdx) => (
                      <span key={cIdx} className="text-xs font-bold bg-amber-500/10 text-amber-200 border border-amber-500/25 px-2.5 py-1 rounded-xl">
                        🎨 {char}
                      </span>
                    ))}
                  </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1">
                    {pkg.cartoonConcept.script.map((line, lIdx) => (
                      <div key={lIdx} className="p-3 rounded-2xl border border-noct-border/60 bg-amber-500/5 space-y-1.5 text-xs">
                        {line.visual && (
                          <div className="bg-amber-500/15 text-amber-100 text-[11px] font-mono font-medium p-2 rounded-xl border border-amber-500/30 leading-relaxed">
                            <span className="font-bold text-amber-300 mr-1.5">🎨 Visual Cue:</span>
                            {line.visual}
                          </div>
                        )}
                        {line.character && line.dialogue && (
                          <div className="pl-1 pt-1 font-medium text-noct-text">
                            <span className="font-extrabold text-amber-300 font-mono mr-1.5 uppercase text-[11px]">
                              {line.character}:
                            </span>
                            <span className={dyslexiaMode ? "dyslexia-mode-styles" : ""}>
                              &quot;{bionicReading && formatBionicText ? formatBionicText(line.dialogue) : line.dialogue}&quot;
                ...
                {/* Educational Takeaway */}
                <div className="p-3 bg-teal-brand/10 border border-teal-brand/20 rounded-2xl text-xs text-noct-text space-y-0.5">
                  <span className="font-bold text-noct-text uppercase text-[10px] font-mono block">
                    🎯 Educational Takeaway
                  </span>
